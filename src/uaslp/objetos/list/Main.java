...
import uaslp.objetos.list.exceptions.CollectionException;
...
public class Main {
    ...
    private static void testGetAtIndex(List<Object> list) throws CollectionException {
        System.out.println("\n-> Test get at index.");
        list.addAtTail("0");
        list.addAtTail(1);
        list.addAtTail('2');
    ...
    private static void testSetAtIndex(List<Object> list) throws CollectionException {
        System.out.println("\n-> Test set at index.");
        list.addAtTail("A");
        list.addAtTail(2);
        list.addAtTail(3);
    ...
    private static void testRemoveNthElement(List<Object> list) throws CollectionException{
